<script>
	import EyeFilled from '$svgs/EyeFilled.svelte';
...
<button id="changeDisplayButton" type="button" title="Display Type" class="inline-flex flex-col items-center justify-center px-5 relative inline-flex items-center group hover:bg-theme-accent/5" on:click={() => __settingsSelectorModal.set({ component: DisplayTypeSelector, visible: true, title: 'Display Type' })} data-rybbit-event="Toolbar Display Change Button">
	<EyeFilled size={5} />
