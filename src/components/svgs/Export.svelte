...
<svg xmlns="http://www.w3.org/2000/svg" class="w-{size} h-{size} {classes}" fill={window.theme('icon')} id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="512" height="512"
	><path
