...
- [Ayman Siddiqui](https://zoopernet.com) for his various contributions, including Indopak Hanafi and Madinah Quran texts and fonts; Uthmanic Mushaf V4 Tajweed fonts; Isep Misbah Quran word by word text compilation and font; Arabic Sign Language word by word compilation; Tajweed Transliteration word by word compilation; Advanced Tajweed Transliteration word by word compilation; Syllables Transliteration word by word compilation; Majidi Quran text and font special features; Quranic metadata; and various other Quranic data, font development, and website testing.
...
- [Understand Quran Academy](https://understandquran.com/) for the Advanced Tajweed and Syllables transliteration data, and Understand Quran Academy in collaboration with [Edusuite Solutions Private Limited](https://www.edusuitesolutions.com/) for the Majidi Nastaleeq Digital Font[7].
