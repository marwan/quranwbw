<script>
	...
	// Tracks whether Turnstile has completed its silent challenge and a token is ready.
...
<div class="mx-auto">
	...
	<div class="relative">
		...
		<!-- Cloud sections dimmed and non-interactive until Turnstile is ready -->
		<div class={!isTurnstileReady && disabledClasses}>
